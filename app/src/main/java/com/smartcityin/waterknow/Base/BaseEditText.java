...
public class BaseEditText extends EditText implements View.OnFocusChangeListener, TextWatcher {
    /**
     * 删除按钮的引用
     */
    ...
    public void setOnListener(OnFocusChangedListener onListener){
        this.onFocusChangedListener=onListener;
    }
    ...
    public interface OnFocusChangedListener{
        void onFocusChanged(View v,boolean hasFoucs);
    }
