 ...
 */
    public class SslPinningWebViewClient extends WebViewClient {
        ...
        public SslPinningWebViewClient(LoadedListener listener)throws IOException {
            ...
            prepareSslPinning(WaterKnowApp.WATER_CONTEXT.getResources().getAssets().open("server.cer"));
        }

        @Override
        public WebResourceResponse shouldInterceptRequest (final WebView view, String url) {
            if(WebDetailsActivity.pinningSwitch.isChecked()) {
        ...
        private void prepareSslPinning(InputStream... certificates)throws IOException {
            ...
            try {
                ...
                InputStream inputStream = WaterKnowApp.WATER_CONTEXT.getResources().getAssets().open("client.p12");
                ...
                sslContext.init(keyManagers, new TrustManager[]{(TrustManager) new MyTrustManager(chooseTrustManager(trustManagers))}, new SecureRandom());
